#import utils
# this file does not work, it is from pyGAG project, not dgl project
import process
import numpy as np
import pickle

#adj, features, labels, idx_train, idx_val, idx_test = process.load_data()
adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, labels = process.load_data_with_label('cora')
...
dump_file = 'decomposed_paths_central_rectangle_cora'
